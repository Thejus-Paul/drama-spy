...
class CreateDramas < ActiveRecord::Migration[8.1]
  def change
    ...
    add_check_constraint :dramas, "last_watched_episode BETWEEN 0 AND total_episodes", name: "last_watched_episode_range_check"
    add_check_constraint :dramas, "total_episodes BETWEEN 1 AND 200", name: "total_episodes_range_check"
  end
end
